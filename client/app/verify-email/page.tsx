...
const VerifyEmailPage = () => {
	...
	const [verificationStatus] = useState<"loading" | "success" | "error">(
		"loading"
	);
	const [timer] = useState(3); // Timer set to 3 seconds
	...
	return (
		<div className='min-h-screen bg-gradient-to-r from-indigo-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 flex flex-col justify-center items-center p-6 space-y-8'>
			{/* Header Section */}
			...
			<Card className='w-full max-w-lg bg-white dark:bg-gray-900 shadow-lg rounded-2xl p-6 transform transition-transform duration-500'>
					...
					{verificationStatus === "loading" && (
						<div className='flex flex-col items-center animate-pulse'>
							...
							<p className='mt-4 text-lg text-gray-600 dark:text-gray-200'>
								Please hold on while we verify your email.
							</p>
						</div>
					)}
					{verificationStatus === "success" && (
						<>
							...
							<p className='text-center text-gray-600 dark:text-gray-200'>
								...
								will be redirected to the login page soon.
							</p>
							<p className='text-center text-lg text-gray-600 dark:text-gray-200'>
								Redirecting in {timer} second
								{timer !== 1 ? "s" : ""}
							</p>
						...
						<>
							...
							<div className='text-gray-600 dark:text-gray-200 mt-4 text-sm text-left space-y-2'>
								...
								<ul className='list-disc pl-6'>
									...
									<li>
										The link might have been already used.
									</li>
									<li>Technical issues on our end.</li>
								</ul>
								<p>
									If you&#39;re still having trouble, reach
			...
			<div className='text-center mt-6 text-sm text-gray-600 dark:text-gray-400'>
				<p>
					Need help?{" "}
					<a href='/contact' className='text-indigo-500'>
						Contact Support
					</a>
				</p>
			</div>
